...
999:
 ...
 // NOT GOOD  - overkill! inherit implementatiomn automatically does the job (because AsString is overridden)
 // well... can maybe display more elements... 
